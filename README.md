...
This release was based on the top of [`sync/master.b`](../../../tree/sync/master.b)., forked on 2026-02-05 ([`18f06c57adf919e8105d79908572336e27de295e`](../../../tree/18f06c57adf919e8105d79908572336e27de295e)), creating the branch [`release/master.b`](../../../tree/release/master.b).
...
#### `components`
The [`components`](./components/) folder contains the components sourced from [`sync/master.b`](../../../tree/sync/master.b) and the additions made to enable building the sources on NuttX. Please note that these components may contain git submodules.
