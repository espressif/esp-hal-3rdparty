...
#if defined(CONFIG_ESPRESSIF_BLE) || defined(CONFIG_ESP32S3_BLE)
...
#if (defined(CONFIG_ESPRESSIF_BLE) || defined(CONFIG_ESP32S3_BLE)) && (defined(CONFIG_ESPRESSIF_WIFI) || defined(CONFIG_ESP32S3_WIFI))
