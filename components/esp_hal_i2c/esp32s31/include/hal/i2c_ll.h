...
#define I2C_LL_GET_NUM(hw)          (hw == &I2C0 ? 0 : (hw == &I2C1 ? 1 : 2))
...
{
    if (i2c_port == 0) {
        HP_SYS_CLKRST.i2c0_ctrl0.reg_i2c0_apb_clk_en = enable;
    } else if (i2c_port == 1) {
        HP_SYS_CLKRST.i2c1_ctrl0.reg_i2c1_apb_clk_en = enable;
    } else {
        HAL_ASSERT(false);
    }
}
...
{
    if (i2c_port == 0) {
        HP_SYS_CLKRST.i2c0_ctrl0.reg_i2c0_rst_en = 1;
        HP_SYS_CLKRST.i2c0_ctrl0.reg_i2c0_rst_en = 0;
    } else if (i2c_port == 1) {
        HP_SYS_CLKRST.i2c1_ctrl0.reg_i2c1_rst_en = 1;
        HP_SYS_CLKRST.i2c1_ctrl0.reg_i2c1_rst_en = 0;
    } else {
        HAL_ASSERT(false);
    }
}
...
{
    if (hw == &I2C0) {
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.i2c0_ctrl0, reg_i2c0_clk_div_num, bus_cfg->clkm_div - 1);
    } else if (hw == &I2C1) {
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.i2c1_ctrl0, reg_i2c1_clk_div_num, bus_cfg->clkm_div - 1);
    } else if (hw == &LP_I2C) {
        HAL_FORCE_MODIFY_U32_REG_FIELD(LP_PERI_CLKRST.i2c_ctrl, lp_i2c_clk_div_num, bus_cfg->clkm_div - 1);
    } else {
        HAL_ASSERT(false);
    }
...
static inline void i2c_ll_master_set_fractional_divider(i2c_dev_t *hw, uint8_t div_a, uint8_t div_b)
{
    ...
    if (hw == &I2C0) {
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.i2c0_ctrl0, reg_i2c0_clk_div_numerator, div_a);
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.i2c0_ctrl0, reg_i2c0_clk_div_denominator, div_b);
    } else if (hw == &I2C1) {
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.i2c1_ctrl0, reg_i2c1_clk_div_numerator, div_a);
        HAL_FORCE_MODIFY_U32_REG_FIELD(HP_SYS_CLKRST.i2c1_ctrl0, reg_i2c1_clk_div_denominator, div_b);
    } else if (hw == &LP_I2C) {
        // LP I2C does not have a fractional divider via LP_PERI_CLKRST
        (void)div_a;
        (void)div_b;
    } else {
        HAL_ASSERT(false);
...
static inline void i2c_ll_set_source_clk(i2c_dev_t *hw, i2c_clock_source_t src_clk)
{
    ...
    if (hw == &I2C0) {
        HP_SYS_CLKRST.i2c0_ctrl0.reg_i2c0_clk_src_sel = (src_clk == I2C_CLK_SRC_RC_FAST) ? 1 : 0;
    } else if (hw == &I2C1) {
        HP_SYS_CLKRST.i2c1_ctrl0.reg_i2c1_clk_src_sel = (src_clk == I2C_CLK_SRC_RC_FAST) ? 1 : 0;
    } else if (hw == &LP_I2C) {
        // LP I2C source clock is configured via lp_i2c_ll_set_source_clk
        return;
    } else {
        HAL_ASSERT(false);
    }
...
{
    if (hw == &I2C0) {
        HP_SYS_CLKRST.i2c0_ctrl0.reg_i2c0_clk_en = en;
    } else if (hw == &I2C1) {
        HP_SYS_CLKRST.i2c1_ctrl0.reg_i2c1_clk_en = en;
    } else if (hw == &LP_I2C) {
        // LP I2C controller clock is managed via lp_i2c_ll_enable_bus_clock
        return;
    } else {
        HAL_ASSERT(false);
    }
...
static inline void lp_i2c_ll_set_source_clk(i2c_dev_t *hw, soc_periph_lp_i2c_clk_src_t src_clk)
{
    ...
    case LP_I2C_SCLK_LP_FAST:
        LP_PERI_CLKRST.i2c_ctrl.lp_i2c_clk_sel = 0;
        break;
    case LP_I2C_SCLK_XTAL:
        LP_PERI_CLKRST.i2c_ctrl.lp_i2c_clk_sel = 1;
        break;
    default:
        HAL_ASSERT(false);
    }
...
{
    (void)hw_id;
    LP_PERI_CLKRST.i2c_ctrl.lp_i2c_clk_en = enable ? 1 : 0;
}
...
{
    (void)hw_id;
    LP_PERI_CLKRST.i2c_ctrl.lp_i2c_rst_en = 1;
    LP_PERI_CLKRST.i2c_ctrl.lp_i2c_rst_en = 0;
}
