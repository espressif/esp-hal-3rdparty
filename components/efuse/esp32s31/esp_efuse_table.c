...
static const esp_efuse_desc_t DIS_USB_SERIAL_JTAG[] = {
    {EFUSE_BLK0, 43, 1}, 	 // [] Represents whether USB-Serial_JTAG is disabled or enabled.,
};
...
static const esp_efuse_desc_t KM_HUK_GEN_STATE[] = {
    {EFUSE_BLK0, 55, 5}, 	 // [] Set this bit to control validation of HUK generate mode. Odd of 1 is invalid; even of 1 is valid,
};

static const esp_efuse_desc_t KM_RND_SWITCH_CYCLE[] = {
    {EFUSE_BLK0, 64, 1}, 	 // [] Set bits to control key manager random number switch cycle. 0: control by register. 1: 8 km clk cycles. 2: 16 km cycles. 3: 32 km cycles,
};

static const esp_efuse_desc_t KM_DISABLE_DEPLOY_MODE[] = {
    {EFUSE_BLK0, 66, 5}, 	 // [] Represents whether the deploy mode of key manager is disabled or not,
};

static const esp_efuse_desc_t KM_DEPLOY_ONLY_ONCE[] = {
    {EFUSE_BLK0, 71, 5}, 	 // [] Set each bit to control whether corresponding key can only be deployed once. 1 is true; 0 is false. Bit0: ecdsa. Bit1: xts. Bit2: hmac. Bit3: ds,
};

static const esp_efuse_desc_t FORCE_USE_KEY_MANAGER_KEY[] = {
    {EFUSE_BLK0, 76, 5}, 	 // [] Set each bit to control whether corresponding key must come from key manager.. 1 is true; 0 is false. Bit0: ecdsa. Bit1: xts. Bit2: hmac. Bit3: ds,
};

static const esp_efuse_desc_t FORCE_DISABLE_SW_INIT_KEY[] = {
    {EFUSE_BLK0, 81, 1}, 	 // [] Set this bit to disable software written init key; and force use efuse_init_key,
};

static const esp_efuse_desc_t XTS_KEY_LENGTH_256[] = {
    {EFUSE_BLK0, 82, 1}, 	 // [] Set this bit to configure flash encryption use xts-128 key; else use xts-256 key,
};

static const esp_efuse_desc_t WDT_DELAY_SEL[] = {
    {EFUSE_BLK0, 83, 1}, 	 // [] Represents whether RTC watchdog timeout threshold is selected at startup. 1: selected. 0: not selected,
};

static const esp_efuse_desc_t DIS_SM_CRYPT[] = {
    {EFUSE_BLK0, 84, 1}, 	 // [] Set this bit to disable all the SM crypto functions,
};
...
static const esp_efuse_desc_t ECC_FORCE_CONST_TIME[] = {
    {EFUSE_BLK0, 121, 1}, 	 // [] Represents whether permanently turn on ECC const-time mode,
};

static const esp_efuse_desc_t ECDSA_ENABLE_SOFT_K[] = {
    {EFUSE_BLK0, 122, 1}, 	 // [] Represents whether hardware random number k is forced used in ESDCA. 1: force used. 0: not force used,
};
...
static const esp_efuse_desc_t XTS_DPA_CLK_ENABLE[] = {
    {EFUSE_BLK0, 125, 1}, 	 // [] Sets this bit to enable xts clock anti-dpa attack function,
};

static const esp_efuse_desc_t XTS_DPA_PSEUDO_LEVEL[] = {
    {EFUSE_BLK0, 128, 2}, 	 // [] Sets this bit to control the xts pseudo-round anti-dpa sttack function,
};
...
static const esp_efuse_desc_t FLASH_TYPE[] = {
    {EFUSE_BLK0, 133, 1}, 	 // [] The type of interfaced flash. 0: four data lines; 1: eight data lines,
};
...
static const esp_efuse_desc_t DIS_USB_SERIAL_JTAG_DOWNLOAD_MODE[] = {
    {EFUSE_BLK0, 148, 1}, 	 // [] Represents whether the USB-Serial-JTAG download function is disabled or enabled. 1: disabled. 0: enabled,
};
...
static const esp_efuse_desc_t DCDC_VSET_EN[] = {
    {EFUSE_BLK0, 194, 1}, 	 // [] Set the dcdc voltage default,
};
...
static const esp_efuse_desc_t SECURE_BOOT_SHA384_EN[] = {
    {EFUSE_BLK0, 203, 1}, 	 // [] Represents whether secure boot using SHA-384 is enabled,
};

static const esp_efuse_desc_t BOOTLOADER_ANTI_ROLLBACK_SECURE_VERSION[] = {
    {EFUSE_BLK0, 204, 4}, 	 // [] Represents the anti-rollback secure version of th2 2nd stage bootloader,
};

static const esp_efuse_desc_t BOOTLOADER_ANTI_ROLLBACK_EN[] = {
    {EFUSE_BLK0, 208, 1}, 	 // [] Represents whether the anti-rollback check for the 2nd stage bootloader is enabled,
};

static const esp_efuse_desc_t BOOTLOADER_ANTI_ROLLBACK_UPDATE_IN_ROM[] = {
    {EFUSE_BLK0, 209, 1}, 	 // [] Represents whether the anti-rollback SECURE_VERSION will be updated from the rom bootloader,
};

static const esp_efuse_desc_t RECOVERY_BOOTLOADER_FLASH_SECTOR[] = {
    {EFUSE_BLK0, 210, 12}, 	 // [] Represents the starting flash sector of the recovery bootloader,
};

static const esp_efuse_desc_t RMA_EN[] = {
    {EFUSE_BLK0, 222, 2}, 	 // [] Represents whether rma function is supported in download mode,
};
...
static const esp_efuse_desc_t RMA_NONCE_ENA[] = {
    {EFUSE_BLK0, 227, 2}, 	 // [] Represents random number NONCE is used in RMA and whether the KM is used to generate the NONCE,
};

static const esp_efuse_desc_t RMA_CHIP_INFO_SOURCE[] = {
    {EFUSE_BLK0, 229, 1}, 	 // [] Represents whether HUK_info is selected as the source for calculating CHIP_info in RMA,
};
...
const esp_efuse_desc_t* ESP_EFUSE_DIS_USB_SERIAL_JTAG[] = {
    &DIS_USB_SERIAL_JTAG[0],    		// [] Represents whether USB-Serial_JTAG is disabled or enabled.
    NULL
};
...
const esp_efuse_desc_t* ESP_EFUSE_KM_DISABLE_DEPLOY_MODE[] = {
    &KM_DISABLE_DEPLOY_MODE[0],    		// [] Represents whether the deploy mode of key manager is disabled or not
    NULL
};
...
const esp_efuse_desc_t* ESP_EFUSE_DIS_SM_CRYPT[] = {
    &DIS_SM_CRYPT[0],    		// [] Set this bit to disable all the SM crypto functions
    NULL
};
...
const esp_efuse_desc_t* ESP_EFUSE_ECC_FORCE_CONST_TIME[] = {
    &ECC_FORCE_CONST_TIME[0],    		// [] Represents whether permanently turn on ECC const-time mode
    NULL
};
...
const esp_efuse_desc_t* ESP_EFUSE_XTS_DPA_PSEUDO_LEVEL[] = {
    &XTS_DPA_PSEUDO_LEVEL[0],    		// [] Sets this bit to control the xts pseudo-round anti-dpa sttack function
    NULL
};
...
const esp_efuse_desc_t* ESP_EFUSE_LOCK_KM_KEY[] = {
    &LOCK_KM_KEY[0],    		// [] Represents whether to lock the efuse xts key
    NULL
};
...
const esp_efuse_desc_t* ESP_EFUSE_DCDC_VSET_EN[] = {
    &DCDC_VSET_EN[0],    		// [] Set the dcdc voltage default
    NULL
};
...
const esp_efuse_desc_t* ESP_EFUSE_SECURE_BOOT_SHA384_EN[] = {
    &SECURE_BOOT_SHA384_EN[0],    		// [] Represents whether secure boot using SHA-384 is enabled
    NULL
};

const esp_efuse_desc_t* ESP_EFUSE_BOOTLOADER_ANTI_ROLLBACK_SECURE_VERSION[] = {
    &BOOTLOADER_ANTI_ROLLBACK_SECURE_VERSION[0],    		// [] Represents the anti-rollback secure version of th2 2nd stage bootloader
    NULL
};

const esp_efuse_desc_t* ESP_EFUSE_BOOTLOADER_ANTI_ROLLBACK_EN[] = {
    &BOOTLOADER_ANTI_ROLLBACK_EN[0],    		// [] Represents whether the anti-rollback check for the 2nd stage bootloader is enabled
    NULL
};

const esp_efuse_desc_t* ESP_EFUSE_BOOTLOADER_ANTI_ROLLBACK_UPDATE_IN_ROM[] = {
    &BOOTLOADER_ANTI_ROLLBACK_UPDATE_IN_ROM[0],    		// [] Represents whether the anti-rollback SECURE_VERSION will be updated from the rom bootloader
    NULL
};

const esp_efuse_desc_t* ESP_EFUSE_RECOVERY_BOOTLOADER_FLASH_SECTOR[] = {
    &RECOVERY_BOOTLOADER_FLASH_SECTOR[0],    		// [] Represents the starting flash sector of the recovery bootloader
    NULL
};

const esp_efuse_desc_t* ESP_EFUSE_RMA_EN[] = {
    &RMA_EN[0],    		// [] Represents whether rma function is supported in download mode
    NULL
};
...
const esp_efuse_desc_t* ESP_EFUSE_RMA_NONCE_ENA[] = {
    &RMA_NONCE_ENA[0],    		// [] Represents random number NONCE is used in RMA and whether the KM is used to generate the NONCE
    NULL
};

const esp_efuse_desc_t* ESP_EFUSE_RMA_CHIP_INFO_SOURCE[] = {
    &RMA_CHIP_INFO_SOURCE[0],    		// [] Represents whether HUK_info is selected as the source for calculating CHIP_info in RMA
    NULL
};

const esp_efuse_desc_t* ESP_EFUSE_RMA_DISABLE_FAST_VEF[] = {
    &RMA_DISABLE_FAST_VEF[0],    		// [] Represents whether disable FAST_VEF in RMA session
    NULL
};
