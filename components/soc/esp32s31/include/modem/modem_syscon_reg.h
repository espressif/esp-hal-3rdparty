...
/* MODEM_SYSCON_RST_COEX_BTMAC : R/W ;bitpos:[20] ;default: 1'b0 ; */
/*description: .*/
#define MODEM_SYSCON_RST_COEX_BTMAC    (BIT(20))
#define MODEM_SYSCON_RST_COEX_BTMAC_M  (BIT(20))
#define MODEM_SYSCON_RST_COEX_BTMAC_V  0x1
#define MODEM_SYSCON_RST_COEX_BTMAC_S  20
/* MODEM_SYSCON_RST_COEX_BTMAC_APB : R/W ;bitpos:[19] ;default: 1'b0 ; */
/*description: .*/
#define MODEM_SYSCON_RST_COEX_BTMAC_APB    (BIT(19))
#define MODEM_SYSCON_RST_COEX_BTMAC_APB_M  (BIT(19))
#define MODEM_SYSCON_RST_COEX_BTMAC_APB_V  0x1
...
/* MODEM_SYSCON_CLK_BTMAC_LOW_RATE : R/W ;bitpos:[0] ;default: 1'h0 ; */
/*description: .*/
#define MODEM_SYSCON_CLK_BTMAC_LOW_RATE    (BIT(0))
#define MODEM_SYSCON_CLK_BTMAC_LOW_RATE_M  (BIT(0))
#define MODEM_SYSCON_CLK_BTMAC_LOW_RATE_V  0x1
#define MODEM_SYSCON_CLK_BTMAC_LOW_RATE_S  0

#define MODEM_SYSCON_MEM_MODE_CONF_REG          (DR_REG_MODEM_SYSCON_BASE + 0x2C)
/* MODEM_SYSCON_MODEM_RF2_MEM_SEL : R/W ;bitpos:[7:4] ;default: 4'b0100 ; */
/*description: .*/
#define MODEM_SYSCON_MODEM_RF2_MEM_SEL    0x0000000F
#define MODEM_SYSCON_MODEM_RF2_MEM_SEL_M  ((MODEM_SYSCON_MODEM_RF2_MEM_SEL_V)<<(MODEM_SYSCON_MODEM_RF2_MEM_SEL_S))
#define MODEM_SYSCON_MODEM_RF2_MEM_SEL_V  0xF
#define MODEM_SYSCON_MODEM_RF2_MEM_SEL_S  4
/* MODEM_SYSCON_MODEM_RF1_MEM_SEL : R/W ;bitpos:[3:0] ;default: 4'b0100 ; */
/*description: .*/
#define MODEM_SYSCON_MODEM_RF1_MEM_SEL    0x0000000F
#define MODEM_SYSCON_MODEM_RF1_MEM_SEL_M  ((MODEM_SYSCON_MODEM_RF1_MEM_SEL_V)<<(MODEM_SYSCON_MODEM_RF1_MEM_SEL_S))
#define MODEM_SYSCON_MODEM_RF1_MEM_SEL_V  0xF
#define MODEM_SYSCON_MODEM_RF1_MEM_SEL_S  0

#define MODEM_SYSCON_DATE_REG          (DR_REG_MODEM_SYSCON_BASE + 0x30)
/* MODEM_SYSCON_DATE : R/W ;bitpos:[27:0] ;default: 28'h2508080 ; */
/*description: .*/
