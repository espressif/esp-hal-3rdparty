...
/** MCPWM_TASK_TIMER0_A_UP_EN : R/W; bitpos: [22]; default: 0;
 *  Configures whether or not to enable timer0 timestamp a update task receive.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_TASK_TIMER0_A_UP_EN    (BIT(22))
#define MCPWM_TASK_TIMER0_A_UP_EN_M  (MCPWM_TASK_TIMER0_A_UP_EN_V << MCPWM_TASK_TIMER0_A_UP_EN_S)
#define MCPWM_TASK_TIMER0_A_UP_EN_V  0x00000001U
#define MCPWM_TASK_TIMER0_A_UP_EN_S  22
/** MCPWM_TASK_TIMER1_A_UP_EN : R/W; bitpos: [23]; default: 0;
 *  Configures whether or not to enable timer1 timestamp a update task receive.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_TASK_TIMER1_A_UP_EN    (BIT(23))
#define MCPWM_TASK_TIMER1_A_UP_EN_M  (MCPWM_TASK_TIMER1_A_UP_EN_V << MCPWM_TASK_TIMER1_A_UP_EN_S)
#define MCPWM_TASK_TIMER1_A_UP_EN_V  0x00000001U
#define MCPWM_TASK_TIMER1_A_UP_EN_S  23
/** MCPWM_TASK_TIMER2_A_UP_EN : R/W; bitpos: [24]; default: 0;
 *  Configures whether or not to enable timer2 timestamp a update task receive.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_TASK_TIMER2_A_UP_EN    (BIT(24))
#define MCPWM_TASK_TIMER2_A_UP_EN_M  (MCPWM_TASK_TIMER2_A_UP_EN_V << MCPWM_TASK_TIMER2_A_UP_EN_S)
#define MCPWM_TASK_TIMER2_A_UP_EN_V  0x00000001U
#define MCPWM_TASK_TIMER2_A_UP_EN_S  24
/** MCPWM_TASK_TIMER0_B_UP_EN : R/W; bitpos: [25]; default: 0;
 *  Configures whether or not to enable timer0 timestamp b update task receive.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_TASK_TIMER0_B_UP_EN    (BIT(25))
#define MCPWM_TASK_TIMER0_B_UP_EN_M  (MCPWM_TASK_TIMER0_B_UP_EN_V << MCPWM_TASK_TIMER0_B_UP_EN_S)
#define MCPWM_TASK_TIMER0_B_UP_EN_V  0x00000001U
#define MCPWM_TASK_TIMER0_B_UP_EN_S  25
/** MCPWM_TASK_TIMER1_B_UP_EN : R/W; bitpos: [26]; default: 0;
 *  Configures whether or not to enable timer1 timestamp b update task receive.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_TASK_TIMER1_B_UP_EN    (BIT(26))
#define MCPWM_TASK_TIMER1_B_UP_EN_M  (MCPWM_TASK_TIMER1_B_UP_EN_V << MCPWM_TASK_TIMER1_B_UP_EN_S)
#define MCPWM_TASK_TIMER1_B_UP_EN_V  0x00000001U
#define MCPWM_TASK_TIMER1_B_UP_EN_S  26
/** MCPWM_TASK_TIMER2_B_UP_EN : R/W; bitpos: [27]; default: 0;
 *  Configures whether or not to enable timer2 timestamp b update task receive.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_TASK_TIMER2_B_UP_EN    (BIT(27))
#define MCPWM_TASK_TIMER2_B_UP_EN_M  (MCPWM_TASK_TIMER2_B_UP_EN_V << MCPWM_TASK_TIMER2_B_UP_EN_S)
#define MCPWM_TASK_TIMER2_B_UP_EN_V  0x00000001U
#define MCPWM_TASK_TIMER2_B_UP_EN_S  27
...
/** MCPWM_EVT_TIMER0_TEA_EN : R/W; bitpos: [6]; default: 0;
 *  Configures whether or not to enable timer0 equal tea event generate.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_EVT_TIMER0_TEA_EN    (BIT(6))
#define MCPWM_EVT_TIMER0_TEA_EN_M  (MCPWM_EVT_TIMER0_TEA_EN_V << MCPWM_EVT_TIMER0_TEA_EN_S)
#define MCPWM_EVT_TIMER0_TEA_EN_V  0x00000001U
#define MCPWM_EVT_TIMER0_TEA_EN_S  6
/** MCPWM_EVT_TIMER1_TEA_EN : R/W; bitpos: [7]; default: 0;
 *  Configures whether or not to enable timer1 equal tea event generate.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_EVT_TIMER1_TEA_EN    (BIT(7))
#define MCPWM_EVT_TIMER1_TEA_EN_M  (MCPWM_EVT_TIMER1_TEA_EN_V << MCPWM_EVT_TIMER1_TEA_EN_S)
#define MCPWM_EVT_TIMER1_TEA_EN_V  0x00000001U
#define MCPWM_EVT_TIMER1_TEA_EN_S  7
/** MCPWM_EVT_TIMER2_TEA_EN : R/W; bitpos: [8]; default: 0;
 *  Configures whether or not to enable timer2 equal tea event generate.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_EVT_TIMER2_TEA_EN    (BIT(8))
#define MCPWM_EVT_TIMER2_TEA_EN_M  (MCPWM_EVT_TIMER2_TEA_EN_V << MCPWM_EVT_TIMER2_TEA_EN_S)
#define MCPWM_EVT_TIMER2_TEA_EN_V  0x00000001U
#define MCPWM_EVT_TIMER2_TEA_EN_S  8
/** MCPWM_EVT_TIMER0_TEB_EN : R/W; bitpos: [9]; default: 0;
 *  Configures whether or not to enable timer0 equal teb event generate.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_EVT_TIMER0_TEB_EN    (BIT(9))
#define MCPWM_EVT_TIMER0_TEB_EN_M  (MCPWM_EVT_TIMER0_TEB_EN_V << MCPWM_EVT_TIMER0_TEB_EN_S)
#define MCPWM_EVT_TIMER0_TEB_EN_V  0x00000001U
#define MCPWM_EVT_TIMER0_TEB_EN_S  9
/** MCPWM_EVT_TIMER1_TEB_EN : R/W; bitpos: [10]; default: 0;
 *  Configures whether or not to enable timer1 equal teb event generate.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_EVT_TIMER1_TEB_EN    (BIT(10))
#define MCPWM_EVT_TIMER1_TEB_EN_M  (MCPWM_EVT_TIMER1_TEB_EN_V << MCPWM_EVT_TIMER1_TEB_EN_S)
#define MCPWM_EVT_TIMER1_TEB_EN_V  0x00000001U
#define MCPWM_EVT_TIMER1_TEB_EN_S  10
/** MCPWM_EVT_TIMER2_TEB_EN : R/W; bitpos: [11]; default: 0;
 *  Configures whether or not to enable timer2 equal teb event generate.
 *  0: Disable
 *  1: Enable
 */
#define MCPWM_EVT_TIMER2_TEB_EN    (BIT(11))
#define MCPWM_EVT_TIMER2_TEB_EN_M  (MCPWM_EVT_TIMER2_TEB_EN_V << MCPWM_EVT_TIMER2_TEB_EN_S)
#define MCPWM_EVT_TIMER2_TEB_EN_V  0x00000001U
#define MCPWM_EVT_TIMER2_TEB_EN_S  11
 ...
 */
#define MCPWM_TIMER0_A    0x0000FFFFU
#define MCPWM_TIMER0_A_M  (MCPWM_TIMER0_A_V << MCPWM_TIMER0_A_S)
#define MCPWM_TIMER0_A_V  0x0000FFFFU
#define MCPWM_TIMER0_A_S  0
/** MCPWM_TIMER0_A_UPMETHOD : R/W; bitpos: [17:16]; default: 0;
 *  Configures the update method for active register of PWM timer0 timestamp a.
 *  0: Immediate
 *  1: TEZ
 *  2: Sync
 *  3: TEZ or sync
 *  TEZ here and below means timer equal zero event
 */
#define MCPWM_TIMER0_A_UPMETHOD    0x00000003U
#define MCPWM_TIMER0_A_UPMETHOD_M  (MCPWM_TIMER0_A_UPMETHOD_V << MCPWM_TIMER0_A_UPMETHOD_S)
#define MCPWM_TIMER0_A_UPMETHOD_V  0x00000003U
#define MCPWM_TIMER0_A_UPMETHOD_S  16
/** MCPWM_TIMER0_A_DIR : R/W; bitpos: [18]; default: 0;
 *  Configures the direction of the timer when timer0 value equal a value for event
 *  trigger.
 *  0: up
 *  1: down
 */
#define MCPWM_TIMER0_A_DIR    (BIT(18))
#define MCPWM_TIMER0_A_DIR_M  (MCPWM_TIMER0_A_DIR_V << MCPWM_TIMER0_A_DIR_S)
#define MCPWM_TIMER0_A_DIR_V  0x00000001U
#define MCPWM_TIMER0_A_DIR_S  18
 ...
 */
#define MCPWM_TIMER0_B    0x0000FFFFU
#define MCPWM_TIMER0_B_M  (MCPWM_TIMER0_B_V << MCPWM_TIMER0_B_S)
#define MCPWM_TIMER0_B_V  0x0000FFFFU
#define MCPWM_TIMER0_B_S  0
/** MCPWM_TIMER0_B_UPMETHOD : R/W; bitpos: [17:16]; default: 0;
 *  Configures the update method for active register of PWM timer0 timestamp b.
 *  0: Immediate
 *  1: TEZ
 *  2: Sync
 *  3: TEZ or sync
 *  TEZ here and below means timer equal zero event
 */
#define MCPWM_TIMER0_B_UPMETHOD    0x00000003U
#define MCPWM_TIMER0_B_UPMETHOD_M  (MCPWM_TIMER0_B_UPMETHOD_V << MCPWM_TIMER0_B_UPMETHOD_S)
#define MCPWM_TIMER0_B_UPMETHOD_V  0x00000003U
#define MCPWM_TIMER0_B_UPMETHOD_S  16
/** MCPWM_TIMER0_B_DIR : R/W; bitpos: [18]; default: 0;
 *  Configures the direction of the timer when timer0 value equal b value for event
 *  trigger.
 *  0: up
 *  1: down
 */
#define MCPWM_TIMER0_B_DIR    (BIT(18))
#define MCPWM_TIMER0_B_DIR_M  (MCPWM_TIMER0_B_DIR_V << MCPWM_TIMER0_B_DIR_S)
#define MCPWM_TIMER0_B_DIR_V  0x00000001U
#define MCPWM_TIMER0_B_DIR_S  18
 ...
 */
#define MCPWM_TIMER1_A    0x0000FFFFU
#define MCPWM_TIMER1_A_M  (MCPWM_TIMER1_A_V << MCPWM_TIMER1_A_S)
#define MCPWM_TIMER1_A_V  0x0000FFFFU
#define MCPWM_TIMER1_A_S  0
/** MCPWM_TIMER1_A_UPMETHOD : R/W; bitpos: [17:16]; default: 0;
 *  Configures the update method for active register of PWM timer1 timestamp a.
 *  0: Immediate
 *  1: TEZ
 *  2: Sync
 *  3: TEZ or sync
 *  TEZ here and below means timer equal zero event
 */
#define MCPWM_TIMER1_A_UPMETHOD    0x00000003U
#define MCPWM_TIMER1_A_UPMETHOD_M  (MCPWM_TIMER1_A_UPMETHOD_V << MCPWM_TIMER1_A_UPMETHOD_S)
#define MCPWM_TIMER1_A_UPMETHOD_V  0x00000003U
#define MCPWM_TIMER1_A_UPMETHOD_S  16
/** MCPWM_TIMER1_A_DIR : R/W; bitpos: [18]; default: 0;
 *  Configures the direction of the timer when timer1 value equal a value for event
 *  trigger.
 *  0: up
 *  1: down
 */
#define MCPWM_TIMER1_A_DIR    (BIT(18))
#define MCPWM_TIMER1_A_DIR_M  (MCPWM_TIMER1_A_DIR_V << MCPWM_TIMER1_A_DIR_S)
#define MCPWM_TIMER1_A_DIR_V  0x00000001U
#define MCPWM_TIMER1_A_DIR_S  18
 ...
 */
#define MCPWM_TIMER1_B    0x0000FFFFU
#define MCPWM_TIMER1_B_M  (MCPWM_TIMER1_B_V << MCPWM_TIMER1_B_S)
#define MCPWM_TIMER1_B_V  0x0000FFFFU
#define MCPWM_TIMER1_B_S  0
/** MCPWM_TIMER1_B_UPMETHOD : R/W; bitpos: [17:16]; default: 0;
 *  Configures the update method for active register of PWM timer1 timestamp b.
 *  0: Immediate
 *  1: TEZ
 *  2: Sync
 *  3: TEZ or sync
 *  TEZ here and below means timer equal zero event
 */
#define MCPWM_TIMER1_B_UPMETHOD    0x00000003U
#define MCPWM_TIMER1_B_UPMETHOD_M  (MCPWM_TIMER1_B_UPMETHOD_V << MCPWM_TIMER1_B_UPMETHOD_S)
#define MCPWM_TIMER1_B_UPMETHOD_V  0x00000003U
#define MCPWM_TIMER1_B_UPMETHOD_S  16
/** MCPWM_TIMER1_B_DIR : R/W; bitpos: [18]; default: 0;
 *  Configures the direction of the timer when timer1 value equal b value for event
 *  trigger.
 *  0: up
 *  1: down
 */
#define MCPWM_TIMER1_B_DIR    (BIT(18))
#define MCPWM_TIMER1_B_DIR_M  (MCPWM_TIMER1_B_DIR_V << MCPWM_TIMER1_B_DIR_S)
#define MCPWM_TIMER1_B_DIR_V  0x00000001U
#define MCPWM_TIMER1_B_DIR_S  18
 ...
 */
#define MCPWM_TIMER2_A    0x0000FFFFU
#define MCPWM_TIMER2_A_M  (MCPWM_TIMER2_A_V << MCPWM_TIMER2_A_S)
#define MCPWM_TIMER2_A_V  0x0000FFFFU
#define MCPWM_TIMER2_A_S  0
/** MCPWM_TIMER2_A_UPMETHOD : R/W; bitpos: [17:16]; default: 0;
 *  Configures the update method for active register of PWM timer2 timestamp a.
 *  0: Immediate
 *  1: TEZ
 *  2: Sync
 *  3: TEZ or sync
 *  TEZ here and below means timer equal zero event
 */
#define MCPWM_TIMER2_A_UPMETHOD    0x00000003U
#define MCPWM_TIMER2_A_UPMETHOD_M  (MCPWM_TIMER2_A_UPMETHOD_V << MCPWM_TIMER2_A_UPMETHOD_S)
#define MCPWM_TIMER2_A_UPMETHOD_V  0x00000003U
#define MCPWM_TIMER2_A_UPMETHOD_S  16
/** MCPWM_TIMER2_A_DIR : R/W; bitpos: [18]; default: 0;
 *  Configures the direction of the timer when timer2 value equal a value for event
 *  trigger.
 *  0: up
 *  1: down
 */
#define MCPWM_TIMER2_A_DIR    (BIT(18))
#define MCPWM_TIMER2_A_DIR_M  (MCPWM_TIMER2_A_DIR_V << MCPWM_TIMER2_A_DIR_S)
#define MCPWM_TIMER2_A_DIR_V  0x00000001U
#define MCPWM_TIMER2_A_DIR_S  18
 ...
 */
#define MCPWM_TIMER2_B    0x0000FFFFU
#define MCPWM_TIMER2_B_M  (MCPWM_TIMER2_B_V << MCPWM_TIMER2_B_S)
#define MCPWM_TIMER2_B_V  0x0000FFFFU
#define MCPWM_TIMER2_B_S  0
/** MCPWM_TIMER2_B_UPMETHOD : R/W; bitpos: [17:16]; default: 0;
 *  Configures the update method for active register of PWM timer2 timestamp b.
 *  0: Immediate
 *  1: TEZ
 *  2: Sync
 *  3: TEZ or sync
 *  TEZ here and below means timer equal zero event
 */
#define MCPWM_TIMER2_B_UPMETHOD    0x00000003U
#define MCPWM_TIMER2_B_UPMETHOD_M  (MCPWM_TIMER2_B_UPMETHOD_V << MCPWM_TIMER2_B_UPMETHOD_S)
#define MCPWM_TIMER2_B_UPMETHOD_V  0x00000003U
#define MCPWM_TIMER2_B_UPMETHOD_S  16
/** MCPWM_TIMER2_B_DIR : R/W; bitpos: [18]; default: 0;
 *  Configures the direction of the timer when timer2 value equal b value for event
 *  trigger.
 *  0: up
 *  1: down
 */
#define MCPWM_TIMER2_B_DIR    (BIT(18))
#define MCPWM_TIMER2_B_DIR_M  (MCPWM_TIMER2_B_DIR_V << MCPWM_TIMER2_B_DIR_S)
#define MCPWM_TIMER2_B_DIR_V  0x00000001U
#define MCPWM_TIMER2_B_DIR_S  18
